...
def LW_combined(str special, int N_sample):
    ...
    cdef np.ndarray[np.float64_t,ndim=1] z, z_ff, t, tau, mass_bins, sigmas, D, all_z, J_z, M_crit_z, J_0, SFRD_II, SFRD_III, MMH, m_gas, m_lost, popIII, popIII_on, popII, popIII_m, popII_m, t_quieses, fIIs, all_m, output, popIII_sfr_bar, popII_sfr_bar, M_star
    ...
    try:
        ...
        print(OSError)
    if special == '_Test':
        save_path = './Box_64_Fiducial_Burst/Testing/'
    ...
    if special == '_Test':
        delta_i, vbc_i, JLW_i = 200, 100, 50
        ...
        save_path = '../NN_Training/Deltas/Delta_200/'
        print('Testing --- ')
